      ...
      <div className="my-20 w-full max-w-[1200px]">
        <div className="flex justify-end pr-10 mb-10">
          <NavLink to="/blogs/page1">
            {
              ({ isActive }) => (
                <button className={`${isActive ? 'bg-[#00000044]' : 'bg-transparent'} text-white h-10 w-10 border text-center hover:bg-[#00000044] active:scale-75 transition-all origin-center`}>1</button>
              )
            }
          </NavLink>
